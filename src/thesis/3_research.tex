...
\end{figure}
\review{Mari-Ell: The sector diagram is not accessible - sectors are only connected to the legend with colour. Also, white text on orange is not contrasted enough. Please change the diagram.}
