...
According to these replies, accessibility has always been seen as something that is at the end of Pipedrive's priorities and there has not been any clear company-wide strategy on how to manage and improve it. There has never been a dedicated project manager to bring focus to this subject
...
A summary table was created from all violations and passes found in the automated tests and violations found in the manual audit. The listed violations and passes were counted to obtain numerical data that can be analyzed using statistical methods (Appendix \ref{appendix:results-table}).
