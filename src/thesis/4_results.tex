...
% 	\caption{Option A: Violations and passes detected by addon-a11y}
...
% 	\centering
% 	\begin{subfigure}{0.46\textwidth}
% 	\includegraphics[width=\textwidth]{img/audit/failed2.png}
% 	\caption{All violations reported by addon-a11y and how many of them are valid.}
% 	\label{fig:audit-failed}
% 	\end{subfigure}
% 	\hspace{0.05\textwidth}
% 	\begin{subfigure}{0.46\textwidth}
% 	\includegraphics[width=\textwidth]{img/audit/passed2.png}
% 	\caption{All passed checks reported by addon-a11y and how many of them are valid.}
% 	\label{fig:audit-passed}
% 	\end{subfigure}
% \caption{Option C: All issues checked by addon-a11y}
% \label{fig:audit-passed-failed}
% \end{figure}
...
% \begin{table}[H]
	% \begin{center}
		...
		% 	\hline
		% 	  \textbf{addon-ally description} & \textbf{ACT rule} & \textbf{WCAG Success Criterion} \\
		% 	\hline
		...
		% 	\hline
		% 	Inline text spacing must be adjustable with custom stylesheets &  & 1.4.12 Text Spacing \\
		% 	\hline
		% 	Scrollable region must have keyboard access &  & 2.1.1 Keyboard 2.1.3 Keyboard (No Exception) \\
		% 	\hline
		% 	Links with the same name must have a similar purpose &  & 2.4.4 Link Purpose (In Context) 2.4.9 Link Purpose (Link Only) \\
		% 	\hline
		% 	Links must have discernible text &  & 2.4.4 Link Purpose (In Context) 2.4.9 Link Purpose (Link Only) \\
		% 	\hline
		% 	 &  &  \\
		% 	\hline
		% \end{tabular}
% 		\begin{center}
% 			\begin{tabular}{ |m{0.4\textwidth}|m{0.15\textwidth}|m{0.35\textwidth}|}
% 				\hline
% 				\thead{addon-ally description} & \thead{ACT rule} & \thead{WCAG Success Criterion} \\
% 				\hline
% 				\makecell[tl]{Images must have alternate text} &    &  \makecell[tl]{1.1.1 Non-text Content} \\
% 				\hline
% 				\makecell[tl]{Certain ARIA roles must contain \\ particular children} &    & \makecell[tl]{1.3.1 Info and Relationships} \\
% 				\hline
% 				\makecell[tl]{Color contrast} &    & \makecell[tl]{1.4.3 Contrast (Minimum) \\ 1.4.6 Contrast (Enhanced)} \\
% 				\hline
% 				\makecell[tl]{Inline text spacing must be \\ adjustable with custom stylesheets} &    & \makecell[tl]{1.4.12 Text Spacing} \\
% 				\hline
% 				\makecell[tl]{Scrollable region must have\\ keyboard access} &    &  \makecell[tl]{2.1.1 Keyboard\\ 2.1.3 Keyboard (No Exception)}\\
% 				\hline
% 				\makecell[tl]{Links with the same name must\\ have a similar purpose} &    &  \makecell[tl]{2.4.4 Link Purpose (In Context)\\ 2.4.9 Link Purpose (Link Only)}\\
% 				\hline
% 				\makecell[tl]{Links must have discernible text} &    &  \makecell[tl]{2.4.4 Link Purpose (In Context)\\ 2.4.9 Link Purpose (Link Only)}\\
% 				\hline
% 				\makecell[tl]{IDs used in ARIA and labels must be \\ unique} &    &  \makecell[tl]{4.1.1 Parsing}\\
% 				\hline
% 				\makecell[tl]{Form elements must have labels} &    &  \makecell[tl]{4.1.2 Name, Role, Value}\\
% 				\hline
% 				\makecell[tl]{Form field must not have multiple\\ label elements} &    &  \makecell[tl]{4.1.2 Name, Role, Value}\\
% 				\hline
% 				\makecell[tl]{Form elements should have a \\visible label} &    &  \makecell[tl]{4.1.2 Name, Role, Value}\\
% 				\hline
% 				\makecell[tl]{ARIA input fields must have an \\accessible name} &    &  \makecell[tl]{4.1.2 Name, Role, Value}\\
% 				\hline
% 				\makecell[tl]{ARIA roles used must conform to \\valid values} &    &  \makecell[tl]{4.1.2 Name, Role, Value}\\
% 				\hline
% 				\makecell[tl]{ARIA commands must have an \\accessible name} &    &  \makecell[tl]{4.1.2 Name, Role, Value}\\
% 				\hline
% 				\makecell[tl]{Interactive controls must not be \\nested} &    &  \makecell[tl]{4.1.2 Name, Role, Value}\\
% 				\hline
% 			\end{tabular}
% 		\end{center}
% \end{table}
...
\begin{itemize}
	...
	% \item Success Criterion 1.4.6 Contrast (Enhanced) (Level AAA)
	...
	% \item Success Criterion 2.1.3 Keyboard (No Exception) (Level AAA)
	...
	% \item Success Criterion 2.4.9 Link Purpose (Link Only) (Level AAA)
