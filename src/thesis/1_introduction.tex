...
\todo{mention that I work in Pipedrive}
...
To explore this a case study and manual accessibility audit will be carried out in the author's current workplace - Pipedrive - a company building a web-based sales \ac{crm}. The case study will consist of adding an automated accessibility testing tool to the company's component library. This will give valuable insights into what using automated accessibility testing tools would look like in a real-life situation. The aim of this is to understand the pros and cons of these tools.
