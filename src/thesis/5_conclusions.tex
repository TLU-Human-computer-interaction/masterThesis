...
The goal of this thesis was to explore the possibilities of automated testing in component libraries. This was achieved by doing a case study on Pipedrive's component library. As a first step a survey was sent out to understand the context where this component library is being used. The results from it showed that that accessibility is seen as something that is currently not the main focus of the company, but should be prioritized more. The level of knowledge among designers and developers in the company is average, but many think they need more resources about the subject.
